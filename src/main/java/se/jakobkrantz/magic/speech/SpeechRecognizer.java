...
public class SpeechRecognizer extends Thread {
    ...
    //private static final String ACOUSTIC_MODEL = SpeechRecognizer.class.getResource("resource:/edu/cmu/sphinx/models/en-us/en-us").toString();
    //private static final String DICTIONARY = SpeechRecognizer.class.getResource("resource:/edu/cmu/sphinx/models/en-us/8949.dic").toString();
    //private static final String KEY_PHRASES = SpeechRecognizer.class.getResource("resource:/edu/cmu/sphinx/models/en-us/keyphrase-list").toString();
