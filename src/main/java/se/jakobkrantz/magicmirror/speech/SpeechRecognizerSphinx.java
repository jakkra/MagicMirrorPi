 ...
 */
public class SpeechRecognizerSphinx extends Thread {
    ...
    //private static final String ACOUSTIC_MODEL = SpeechRecognizerSphinx.class.getResource("resource:/cmu.edu/cmu/sphinx/models/en-us/en-us").toString();
    //private static final String DICTIONARY = SpeechRecognizerSphinx.class.getResource("resource:/cmu.edu/cmu/sphinx/models/en-us/8949.dic").toString();
    //private static final String KEY_PHRASES = SpeechRecognizerSphinx.class.getResource("resource:/cmu.edu/cmu/sphinx/models/en-us/keyphrase-list").toString();
    ...
    public void run() {
        String jarDir = "";
        try {
            jarDir = SpeechRecognizerSphinx.class.getProtectionDomain().getCodeSource().getLocation().toURI().getPath();
